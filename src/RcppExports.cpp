...
RcppExport SEXP _bartXViz_genOMat(SEXP num_rowsSEXP, SEXP num_colsSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _bartXViz_genFrankensteinMatrices(SEXP XSEXP, SEXP WSEXP, SEXP OSEXP, SEXP featureSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_bartXViz_genOMat", (DL_FUNC) &_bartXViz_genOMat, 2},
    {"_bartXViz_genFrankensteinMatrices", (DL_FUNC) &_bartXViz_genFrankensteinMatrices, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_bartXViz(DllInfo *dll) {
