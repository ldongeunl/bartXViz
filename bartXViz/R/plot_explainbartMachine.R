...
#'
#' @param object An explainbartMachine class object containing the Shapley values of the BART model.
...
#' @export
plot.explainbartMachine <- function(object, average = NULL,adjust=FALSE,
                             type = NULL,  num_post=NULL,
                             plot.flag = TRUE, probs=0.95,title=NULL,...){

    plot.explainBART (object= object, average=average , type = type,
