...
#'
#' @param object An explainBART class object containing the Shapley values of the BART model.
...
plot.explainBART <- function(object, average = NULL,title=NULL,
                             type = NULL,  num_post= NULL,adjust= FALSE,
                             plot.flag=TRUE, probs=0.95,...){
